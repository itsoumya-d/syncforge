# Commercial License — SyncForge

> Replaces: Firebase Realtime DB ($0.06/GB stored + $1/GB downloaded), Supabase ($25-$599/mo), MongoDB Atlas.
> SyncForge stores data locally in IndexedDB with CRDT-based conflict resolution. Works 100% offline.

## Pricing

| Tier | Price | What You Get |
|:-----|:------|:-------------|
| **Indie** | $399/year | 1 developer, 1 application |
| **Startup** | $2,999/year | Up to 15 developers, 5 applications |
| **Enterprise** | $14,999/year | Unlimited developers, unlimited apps, priority support (24hr SLA) |
| **Platform / OEM** | $29,999/year | White-label rights, embed in your product, resell |
| **Full IP Buyout** | $1,500,000 | Complete intellectual property transfer |

### Why This Pricing?

A collaborative SaaS app with 100K MAU on Firebase:
- **Firebase**: $2,000–$15,000/month ($24K–$180K/year)
- **Supabase Pro**: $599/month ($7,200/year) + overages
- **SyncForge Enterprise**: $14,999/**year** (saving $10K–$165K/year + works offline)
